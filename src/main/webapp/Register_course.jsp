        ...
        <table>
            ...
            <tr>
              <td>
                ...
                <input type="text" name="course_id" id="course_id" required="true" placeholder="Course Id here">
              </td>
              <td>
                <label for="course_name">Course Name: </label>
                <input type="text" id="course_name" name="course_name" required="true" placeholder="Course name here">
              </td>
            </tr>
            <tr>
              <td>
            ...
            <tr>
              ...
              <td>
                ...
                <input type="number" id="credit_hour" name="credit_hour" required="true" placeholder="Credit hour here">
              </td>
            </tr>
            <tr>
            <td>
